...
Now we summarise the data with means by activity and subject
…by first preparing the dots component of the call to summarise making sure we use the proper variable names
```{r}
